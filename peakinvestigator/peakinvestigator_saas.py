...
class PeakInvestigatorSaaS(object):
    ...
    Here's an example::
        ...
        service =
            PeakInvestigatorSaaS("https://peakinvestigator.veritomyx.com")
    ...
    def upload(self, upload_action, local_file, progress_factory, num_scan=0):
        ...
        uploader = Uploader(upload_action.host,
                            upload_action.token, progress_factory)
