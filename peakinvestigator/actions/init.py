...
class InitAction(BaseAction):
    ...
    def __init__(self, api_version, username,
                 password, project_id, pi_version):
        """Constructor
    ...
    def with_mass_range(self, *args, **kwds):
        ...
        If keywords are provided, start and end are used to specify the
        starting and ending range, respectively.
    ...
    @property
    def job(self):
        """The job to be used in subsequent API calls
        (i.e. RUN, STATUS, and DELETE).
