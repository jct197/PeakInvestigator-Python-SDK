...
class TestSandboxAction(unittest.TestCase):
    ...
    def test_responseInit(self):
        ...
        actionInit = SandboxAction(InitAction("5.1",
                                              "user", "password", "100", "1.2")
        ...
        """
        self.assertEqual(actionInit.build_query(),
                         dict(Version="5.1", User="user", Code="password",
                              Action="INIT", ID="100", PI_Version="1.2",
                              ScanCount=5, CalibrationCount=0, MaxPoints=12345,
                              MinMass=50, MaxMass=100, StartMass=50,
                              EndMass=100, ClientKey="SDKTest",
                              Sandbox="0"))
    ...
    def test_responseRun(self):
        ...
        """
        self.assertEqual(actionRun.build_query(),
                         dict(Version="5.1", User="user", Code="password",
                              Action="RUN", Job="100", RTO="RTO-24",
                              InputFile="production.data.tar",
                              CalibrationFile="calibration.data.tar",
                              Sandbox="0"))
    ...
    def test_responseStatus(self):
        ...
        actionStatus = SandboxAction(
            StatusAction("5.1", "user", "password", "100"))
        response1 = """
        {
            "Action":"STATUS",
            "Job":"P-504.5148",
        ...
        """
        self.assertEqual(actionStatus.build_query(),
                         dict(Version="5.1", User="user", Code="password",
                              Action="STATUS", Job="100", Sandbox="0"))
        ...
        self.assertEqual(False, actionStatus.done)
        self.assertEqual(datetime.datetime(2016, 2, 3, 18, 36, 5),
                         actionStatus.last_changed)
